...
def inception_module(x, filters_1x1, filters_3x3_reduce, filters_3x3,
                     ...
                     bias_init, kernel_init, name=None):
    ...
    conv_3x3 = Conv2D(filters_3x3, kernel_size=(3, 3), padding='same',
                      activation='relu', kernel_initializer=kernel_init, bias_initializer=bias_init)(pre_conv_3x3)
    ...
    conv_5x5 = Conv2D(filters_5x5, kernel_size=(5, 5), padding='same',
                      activation='relu', kernel_initializer=kernel_init, bias_initializer=bias_init)(pre_conv_5x5)

    # Route 4: 3x3 Max Pooling + 1x1 Convolution
    pool_proj = MaxPooling2D(pool_size=(
...
def googlenet():
    ...
    # GoogLeNet Part 1
    x = Conv2D(filters=64, kernel_size=(7, 7), padding='same', strides=(2, 2), activation='relu',
    ...
    x = MaxPooling2D(pool_size=(3, 3), padding='same',
                     strides=(2, 2), name='max_pool_1_3x3/2')(x)

    x = BatchNormalization()(x)

    x = Conv2D(filters=64, kernel_size=(1, 1), padding='same',
               strides=(1, 1), activation='relu', name='conv_2a_1x1/1')(x)
    ...
    x = MaxPooling2D(pool_size=(3, 3), padding='same',
                     strides=(2, 2), name='max_pool_2_3x3/2')(x)
    ...
    x = MaxPooling2D(pool_size=(3, 3), padding='same',
                     strides=(2, 2), name='max_pool_4_3x3/2')(x)
    ...
    x = AveragePooling2D(pool_size=(7, 7), padding='valid',
                         strides=1, name='avg_pool_1_7x7/1')(x)
