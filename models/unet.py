# U-Net Architecture
# Author: Olaf Ronneberger, 2015
# Adapted from: Sreenivas Bhattiprolu, Python for Microscopists
...
def unet(input_width=256, input_height=256, input_channels=3, metrics=["accuracy"]):
...
def main():
    ...
    with open("../summaries/unet.txt", "w") as sys.stdout:
        model.summary()
    sys.stdout = sys.__stdout__

    plot_model(model, to_file="../figures/unet.png", show_shapes=True)
